 ...
 var scratchblocks = function() {
    ...
    function a(e, t) {
        ...
        if ("undefined" == typeof Symbol || null == e[Symbol.iterator]) {
            if (Array.isArray(e) || (a = s(e)) || t && e && "number" == typeof e.length) {
                a && (e = a);
                var n = 0
                  , r = function() {};
                return {
    ...
    function c(e, t) {
        ...
        Object.keys(t.aliases).forEach(function(e) {
            var o = t.aliases[e]
              , i = D[o];
            if (i === void 0)
                throw new Error("Invalid alias '" + o + "'");
            var a = n(e);
            s[a] = i,
            t.nativeAliases[o] = e
        }),
    ...
    function y(e, t, s) {
        var n = [];
        g(t[t.length - 1]) && (n = t.pop());
        for (var r, c = [], l = 0; l < t.length; l++)
            r = t[l],
            r.isLabel ? c.push(r.value) : r.isIcon ? c.push("@" + r.name) : c.push("_");
        var p = c.join(" ")
          , h = e.hash = ge(p)
          , d = fe(h, e, t, s);
        if (d) {
            ...
            ("ring" === u.shape ? "reporter" === e.shape : "stack" === e.shape) && (e.shape = u.shape),
            ...
            try {
                for (m.s(); !(f = m.n()).done; ) {
                    ...
                    if (b(t, k)) {
                        e.shape = "define-hat",
                        e.category = "custom";
                        for (var w, A = t.splice(k.definePrefix.length, t.length - k.defineSuffix.length), S = 0; S < A.length; S++) {
                            if (w = A[S],
                            w.isInput && w.isBoolean)
                                w = y({
                                    shape: "boolean",
                                    argument: "boolean",
                                    category: "custom-arg"
                                }, [new oe("")], s);
                            else if (w.isInput && ("string" === w.shape || "number" === w.shape)) {
                                var L = w.value.split(/ +/g).map(function(e) {
                                    return new oe(e)
                                });
                                w = y({
                                    shape: "reporter",
                                    argument: "string" === w.shape ? "string" : "number",
                                    category: "custom-arg"
                                }, L, s)
                            } else
                                (w.isReporter || w.isBoolean) && w.info.categoryIsDefault && (w.info.category = "custom-arg",
                                w.info.argument = w.isBoolean ? "boolean" : "number");
                            A[S] = w
                        }
                        var O = new ne({
                            shape: "outline",
                        ...
                        t.splice(k.definePrefix.length, 0, O);
                        break
                    }
                }
            } catch (e) {
        ...
        ye(e, n),
        e.hasLoopArrow && t.push(new ie("loopArrow"));
        var v = new ne(e,t);
        return (u && ke.test(u.spec) && v.translate(o, !0),
        "+" === e.diff) ? new ce(v) : (v.diff = e.diff,
        v)
    }
    function b(e, t) {
        ...
        for (var s = 0; s < t.definePrefix.length; s++) {
            var o = t.definePrefix[s]
              , a = e[s];
            if (!a.isLabel || ge(a.value) !== ge(o))
                return !1
        }
        for (var s = 1; s <= t.defineSuffix.length; s++) {
            var n = t.defineSuffix[t.defineSuffix.length - s]
              , r = e[e.length - s];
            if (!r.isLabel || ge(r.value) !== ge(n))
                return !1
        }
        return !0
    }
    function k(e, t) {
        ...
        function l(e) {
            for (var t, s = []; L && "\n" !== L; ) {
                ...
                case "@":
                    o();
                    for (var c = ""; L && /[a-zA-Z]/.test(L); )
                        c += L,
                        o();
                    "cloud" === c ? s.push(new oe("\u2601")) : s.push(ie.icons.hasOwnProperty(c) ? new ie(c) : new oe("@" + c)),
                    t = null;
                    break;
                case "\\":
                    o();
        ...
        function p() {
            ...
            return "]" === L && o(),
            ue.test(e) ? new ae("color",e) : !t && / v$/.test(e) ? c("dropdown", e.slice(0, e.length - 2)) : new ae("string",e)
        }
        function h(e) {
            var t = l(e);
            if (L && "\n" === L && (S = !0,
            ...
            0 !== t.length) {
                if (1 === t.length) {
                    var s = t[0];
                    if (s.isBlock && (s.isReporter || s.isBoolean || s.isRing))
                        return s
                }
                return r("stack", t)
            }
        ...
        function d() {
            ...
            if (1 === e.length && e[0].isLabel) {
                var t = e[0].value;
                if (/^[0-9e.-]*$/.test(t))
                    return new ae("number",t);
                if (ue.test(t))
                    return new ae("color",t)
            }
            ...
            if (s === e.length) {
                ...
                if (1 < s && "v" === n.value) {
                    ...
                    return c("number-dropdown", t)
                }
            }
            var p = r("reporter", e);
            if (p.info && "ring" === p.info.shape) {
                var h = p.children[0];
                h && h.isInput && "number" === h.shape && "" === h.value ? p.children[0] = new ae("reporter") : (h && h.isScript && h.isEmpty || h && h.isBlock && !h.children.length) && (p.children[0] = new ae("stack"))
            }
            return p
        }
        function u() {
            ...
            var e = l(">");
            return L && ">" === L && o(),
            0 === e.length ? new ae("boolean") : r("boolean", e)
        }
        function g() {
            o(),
            S = !1;
            ...
            "}" === L && o(),
            S ? new le(s) : (m(1 >= s.length),
            s.length ? s[0] : r("stack", []))
        }
        function f() {
            var e = L;
            return o(),
            "\u25B8" === e ? new ie("addInput") : "\u25C2" === e ? new ie("delInput") : void 0
        }
        function b(e) {
            o(),
            o();
        ...
        function A() {
            ...
            if ("/" === L && "/" === a()) {
                var s = k();
                if (s.hasBlock = t && t.children.length,
                !s.hasBlock)
                    return s;
                t.comment = s
            }
            ...
            for (var e = []; n; ) {
                for (var o = []; n && "NL" !== n; ) {
                    var a = i()
                      , r = "+" === a.diff;
                    if (r && (a.diff = null),
                    (a.isElse || a.isEnd) && (a = new ne(t({}, a.info, {
                        shape: "stack"
                    }),a.children)),
                    r) {
                        var c = o[o.length - 1]
                        ...
                        l.push(a),
                        o.push(new ce(new le(l)))
                    } else if (a.isHat)
                        o.length && e.push(new le(o)),
                        o = [a];
                    else if (a.isFinal) {
                        o.push(a);
                        break
                ...
                for (o.length && e.push(new le(o)); "NL" === n; )
                    s()
            }
            return e
        }
    ...
    function A(e, t) {
        e.isScript ? e.blocks = e.blocks.map(function(e) {
            return A(e, t),
            t(e) || e
        }) : e.isBlock ? e.children = e.children.map(function(e) {
            return A(e, t),
            t(e) || e
        }) : e.isGlow && A(e.child, t)
    }
    function S(e) {
            ...
            A(e, function(e) {
                if (e.isBlock)
                    if ("define-hat" === e.info.shape) {
                        ...
                        var p = we(e);
                        o[p] && (e.info.category = "custom-arg",
        ...
        e.forEach(function(e) {
            A(e, function(e) {
                if (e.info && e.info.categoryIsDefault && "obsolete" === e.info.category) {
                    var i = t[e.info.hash];
                    return void (i && (e.info.selector = "call",
                    e.info.call = i.spec,
                    e.info.names = i.names,
                    e.info.category = "custom"))
                }
                var a, i;
                if (e.isReporter && "variables" === e.info.category && e.info.categoryIsDefault && (e.info.selector = "readVariable",
                a = we(e),
                i = e.info),
                !!a)
                    if (s[a])
    ...
    var R = ["motion", "looks", "sound", "pen", "variables", "list", "events", "control", "sensing", "operators", "custom", "custom-arg", "extension", "grey", "obsolete", "music", "video", "tts", "translate", "wedo", "ev3", "microbit", "makeymakey"]
      , I = ["hat", "cap", "stack", "boolean", "reporter", "ring", "cat"]
      , C = /(%[a-zA-Z0-9](?:\.[a-zA-Z0-9]+)?)/
      , T = new RegExp(C.source,"g")
      , N = /(@[a-zA-Z]+)/
      , M = new RegExp([C.source, "|", N.source, "| +"].join(""),"g")
      , P = /^#(?:[0-9a-fA-F]{3}){1,2}?$/
      , x = {}
      , D = {}
      , B = [{
        ...
        if (!e.id) {
            if (!e.selector)
                throw new Error("Missing ID: " + e.spec);
            e.id = "sb2:" + e.selector
        }
        if (!e.spec)
            throw new Error("Missing spec: " + e.id);
        var s = {
            id: e.id,
            spec: e.spec,
            parts: e.spec.split(M).filter(function(e) {
                return !!e
            }),
    ...
    h("SOUND_CHANGEEFFECTBY", "LOOKS_CHANGEEFFECTBY", function(e, t) {
        for (var s, o = 0; o < e.length; o++)
            if (s = e[o],
            "dropdown" === s.shape) {
                var n, c = s.value, l = a(t.soundEffects);
                try {
                    for (l.s(); !(n = l.n()).done; ) {
                        var p = n.value;
                        if (r(p) === r(c))
    ...
    var G = {
        ...
        lookupDropdown: function(e, t) {
            for (var s, o = 0; o < t.length; o++)
                if (s = t[o],
                s.nativeDropdowns.hasOwnProperty(e)) {
        ...
        lookupHash: function(e, t, s, o) {
            for (var a, n = 0; n < o.length; n++)
                if (a = o[n],
                a.blocksByHash.hasOwnProperty(e)) {
                    var r = a.blocksByHash[e];
                    if ("reporter" === t.shape && "reporter" !== r.shape)
                        continue;
                    if ("boolean" === t.shape && "boolean" !== r.shape)
                        continue;
                    return r.specialCase && (r = r.specialCase(t, s, a) || r),
                    {
                        type: r,
                        lang: a
                    }
        ...
        applyOverrides: function(e, t) {
            for (var s, o = 0; o < t.length; o++)
                ...
                P.test(s) ? (e.color = s,
                e.category = "",
                e.categoryIsDefault = !1) : -1 < R.indexOf(s) ? (e.category = s,
                e.categoryIsDefault = !1) : -1 < I.indexOf(s) ? e.shape = s : "loop" === s ? e.hasLoopArrow = !0 : ("+" === s || "-" === s) && (e.diff = s)
        },
        rtlLanguages: ["ar", "ckb", "fa", "he"],
        iconPat: N,
        hashSpec: n,
        parseSpec: function(e) {
            var t = e.split(M).filter(function(e) {
                return !!e
            })
    ...
    var Q = function(e, s, o) {
        ...
        this.hasPuzzle = "stack" === i || "hat" === i || "cat" === i,
    ...
    Q.prototype.stringify = function(e) {
        var t = null
          , s = !1
          , o = this.children.map(function(e) {
            return e.isIcon && (s = !0),
        ...
        if (s && i && this.info.selector) {
            var a = V[this.info.id]
              , n = a.spec
              , r = i.nativeAliases[a.spec];
            if (r)
                return j.test(r) && t && (r = r.replace(j, t.stringify())),
                r
        }
        var c = e || "";
        return (!1 === this.info.categoryIsDefault || "custom-arg" === this.info.category && (this.isReporter || this.isBoolean) || "custom" === this.info.category && "stack" === this.info.shape) && (c && (c += " "),
        c += this.info.category),
        c && (o += " :: " + c),
    ...
    Q.prototype.translate = function(e, t) {
        ...
        if (o) {
            if ("PROCEDURES_DEFINITION" === o) {
                ...
                this.children = [];
                var n, r = a(e.definePrefix);
                try {
                    for (r.s(); !(n = r.n()).done; ) {
                        var c = n.value;
                        this.children.push(new X(c))
                    }
                } catch (e) {
                    r.e(e)
                } finally {
                ...
                var l, p = a(e.defineSuffix);
                try {
                    for (p.s(); !(l = p.n()).done; ) {
                        var h = l.value;
                        this.children.push(new X(h))
                    }
                } catch (e) {
                    p.e(e)
                } finally {
            ...
            var d = V[o]
              , u = this.info.language.commands[d.spec]
              , g = e.commands[d.spec];
            if (g) {
                var f = _(g)
                  , m = this.children.filter(function(e) {
                ...
                var y = _(u).parts
                  ...
                  , A = m.slice(k);
                this.children = f.parts.map(function(e) {
                    var e = e.trim();
                    if (e) {
                        var t = U(e);
                        return t ? w[t - 1] : Y.test(e) ? new q(e.slice(1)) : new X(e)
                    }
                }).filter(function(e) {
                    return !!e
                }),
                A.forEach(function(t, o) {
                    1 === o && "CONTROL_IF" === s.info.id && s.children.push(new X(e.commands["else"])),
                    s.children.push(t)
                }),
                this.info.language = e,
                this.info.isRTL = -1 < K.indexOf(e.code),
    ...
    te.prototype.stringify = function() {
        return this.scripts.map(function(e) {
            return e.stringify()
        }).join("\n\n")
    }
    ,
    ...
    var se = {
      ...
      , xe = e(function(e) {
        ...
        var i, a, n = {
            ...
            setProps: function(e, t) {
                for (var s in t) {
                    var o = "" + t[s];
                    n[s] ? e[s] = o : /^xlink:/.test(s) ? e.setAttributeNS("http://www.w3.org/1999/xlink", s.slice(6), o) : null !== t[s] && t.hasOwnProperty(s) && e.setAttributeNS(null, s, o)
                }
                return e
            },
            ...
            polygon: function(e) {
                return c.el("polygon", s(e, {
                    points: e.points.join(" ")
                }))
            },
            path: function(e) {
                return c.el("path", s(e, {
                    path: null,
                    d: e.path.join(" ")
                }))
            },
            ...
            translatePath: function(e, t, s) {
                for (var a, n = !0, r = s.split(" "), c = [], l = 0; l < r.length; l++) {
                    if (a = r[l],
                    "A" === a) {
                        var p = l + 5;
                        for (c.push("A"); l < p; )
            ...
            roundedPath: function(e, t) {
                var s = t / 2;
                return ["M", s, 0, c.arc(e - s, 0, e - s, t, s, s), c.arc(s, t, s, 0, s, s), "Z"]
            },
            roundedRect: function(e, t, o) {
                return c.path(s(o, {
                    path: c.roundedPath(e, t)
                }))
            },
            ...
            pointedRect: function(e, t, o) {
                return c.path(s(o, {
                    path: c.pointedPath(e, t)
                }))
            },
            getTop: function(e) {
                return ["M", 0, 3, "L", 3, 0, "L", 13, 0, "L", 16, 3, "L", 24, 3, "L", 27, 0, "L", e - 3, 0, "L", e, 3].join(" ")
            },
            ...
            getRightAndBottom: function(e, t, s, o) {
                ...
                return s && (i = i.concat(["L", o + 27, t, "L", o + 24, t + 3, "L", o + 16, t + 3, "L", o + 13, t])),
                i = 0 < o ? i.concat(["L", o + 2, t, "L", o, t + 2]) : i.concat(["L", o + 3, t, "L", 0, t - 3]),
                i.join(" ")
            },
            getArm: function(e, t) {
            ...
            hatRect: function(e, t, o) {
                return c.path(s(o, {
                    path: ["M", 0, 12, c.arc(0, 12, 80, 10, 80, 80), "L", e - 3, 10, "L", e, 13, c.getRightAndBottom(e, t, !0), "Z"]
                }))
            },
            ...
            procHatBase: function(e, t, o, i) {
                var o = v(.2, 35 / e);
                return c.path(s(i, {
                    path: ["M", 0, 15, "Q", c.curve(0, 15, e, 15, o), c.getRightAndBottom(e, t, !0), "M", -1, 13, "Q", c.curve(-1, 13, e + 1, 13, o), "Q", c.curve(e + 1, 13, e, 16, .6), "Q", c.curve(e, 16, 0, 16, -o), "Q", c.curve(0, 16, -1, 13, .6), "Z"]
                }))
            },
            procHatCap: function(e, t, s) {
                return c.path({
                    path: ["M", -1, 13, "Q", c.curve(-1, 13, e + 1, 13, s), "Q", c.curve(e + 1, 13, e, 16, .6), "Q", c.curve(e, 16, 0, 16, -s), "Q", c.curve(0, 16, -1, 13, .6), "Z"],
                    class: "sb-define-hat-cap"
                })
            },
            procHatRect: function(e, t, s) {
                var o = v(.2, 35 / e);
                return c.move(0, t - 52, c.group([c.procHatBase(e, 52, o, s), c.procHatCap(e, 52, o)]))
            },
            mouthRect: function(e, t, o, a, n) {
                for (var r, l = a[0].height, h = [c.getTop(e), c.getRightAndBottom(e, l, !0, 15)], p = 1; p < a.length; p += 2) {
                    r = p + 2 === a.length,
                    l += a[p].height - 3,
                    h.push(c.getArm(e, l));
                    var d = !(r && o)
            ...
            ringRect: function(e, t, o, i, a, n, r) {
                var l = "reporter" === n ? c.roundedPath : "boolean" === n ? c.pointedPath : 40 > i ? c.ringCapPath : c.capPath;
                return c.path(s(r, {
                    path: ["M", 8, 0, c.arcw(8, 0, 0, 8, 8, 8), c.arcw(0, t - 8, 8, t, 8, 8), c.arcw(e - 8, t, e, t - 8, 8, 8), c.arcw(e, 8, e - 8, 0, 8, 8), "Z", c.translatePath(4, o || 4, l(i, a).join(" "))],
                    "fill-rule": "even-odd"
                }))
            },
            commentRect: function(e, t, o) {
                return c.path(s(o, {
                    class: "sb-comment",
                    path: ["M", 6, 0, c.arc(e - 6, 0, e, 6, 6, 6), c.arc(e, t - 6, e - 6, t, 6, 6), c.arc(6, t, 0, t - 6, 6, 6), c.arc(0, 6, 6, 0, 6, 6), "Z"]
                }))
            },
            commentLine: function(e, t) {
                return c.move(-e, 9, c.rect(e, 2, s(t, {
      ...
      , bt = xe.commentRect
      , kt = xe.commentLine
      , wt = xe.strikethroughLine
      , At = function(e, t) {
        this.el = xe.el("filter", O(t, {
            id: e,
            x0: "-50%",
            y0: "-50%",
            width: "200%",
    ...
    At.prototype.fe = function(e, t, s) {
        ...
        return this.el.appendChild(xe.withChildren(xe.el("fe" + e, O(t, {
            result: i
        })), s || [])),
        i
    }
    ...
    At.prototype.subtract = function(e, t) {
        return this.comp("arithmetic", e, t, {
            k2: 1,
            k3: -1
        })
    }
    ...
    At.prototype.merge = function(e) {
        this.fe("Merge", {}, e.map(function(e) {
            return xe.el("feMergeNode", {
                in: e
            })
        }))
    }
        ...
        var t = e.exports = {
            ...
            makeIcons: function() {
                return [xe.el("path", {
                    ...
                    fill: "#111",
                    id: "delInput"
                }), xe.setProps(xe.group([xe.el("path", {
                    d: "M8 0l2 -2l0 -3l3 0l-4 -5l-4 5l3 0l0 3l-8 0l0 2",
                    fill: "#000",
                    opacity: "0.3"
                }), xe.move(-1, -1, xe.el("path", {
                    d: "M8 0l2 -2l0 -3l3 0l-4 -5l-4 5l3 0l0 3l-8 0l0 2",
                    fill: "#fff",
                    opacity: "0.9"
                }))]), {
            ...
            makeStyle: function() {
                var e = xe.el("style");
                return e.appendChild(xe.cdata(t.cssContent)),
                e
            },
            bevelFilter: function(e, t) {
                var o = new St(e)
                  ...
                  , a = t ? -1 : 1
                  , s = o.blur(1, i);
                return o.merge(["SourceGraphic", o.comp("in", o.flood("#fff", .15), o.subtract(i, o.offset(+a, +a, s))), o.comp("in", o.flood("#000", .7), o.subtract(i, o.offset(-a, -a, s)))]),
                o.el
            },
            darkFilter: function(e) {
                var t = new St(e);
                return t.merge(["SourceGraphic", t.comp("in", t.flood("#000", .2), "SourceAlpha")]),
                t.el
            },
            darkRect: function(e, t, s, o) {
                return xe.setProps(xe.group([xe.setProps(o, {
                    class: ["sb-" + s, "sb-darker"].join(" ")
                })]), {
                    width: e,
                    height: t
                })
    ...
    Yt.prototype.measure = function() {
        var e = this.value
          , t = "sb-" + this.cls;
        this.el = xe.text(0, 10, e, {
            class: "sb-label " + t
        });
        var s = Yt.metricsCache[t];
        if (s || (s = Yt.metricsCache[t] = Object.create(null)),
        Object.hasOwnProperty.call(s, e))
            this.metrics = s[e];
        else {
            var o = /comment-label/.test(this.cls) ? "bold 12px Helevetica, Arial, DejaVu Sans, sans-serif" : /literal/.test(this.cls) ? "normal 9px " + zt : "bold 10px " + zt;
    ...
    Wt.shapes = {
        string: xe.rect,
        number: xe.roundedRect,
        "number-dropdown": xe.roundedRect,
        color: xe.rect,
        dropdown: xe.rect,
        boolean: xe.pointedRect,
        stack: xe.stackRect,
        reporter: xe.roundedRect
    },
    Wt.prototype.draw = function(e) {
        if (this.hasLabel)
            var t = this.label.draw()
              , s = E(14, this.label.width + ("string" === this.shape || "number-dropdown" === this.shape ? 6 : 9));
        else
            var s = this.isInset ? 30 : this.isColor ? 13 : null;
        this.hasArrow && (s += 10),
        this.width = s;
        var o = this.height = this.isRound || this.isColor ? 13 : 14
          , i = Wt.shapes[this.shape](s, o);
        this.isColor ? xe.setProps(i, {
            fill: this.value
        }) : this.isDarker && (i = _t(s, o, e.info.category, i),
        e.info.color && xe.setProps(i, {
            fill: e.info.color
        }));
        var a = xe.group([xe.setProps(i, {
            class: ["sb-input", "sb-input-" + this.shape].join(" ")
        })]);
        if (this.hasLabel) {
            var n = this.isRound ? 5 : 4;
            a.appendChild(xe.move(n, 0, t))
        }
        if (this.hasArrow) {
            var r = "dropdown" === this.shape ? 5 : 4;
            a.appendChild(xe.move(s - 10, r, xe.polygon({
    ...
    Xt.shapes = {
        stack: xe.stackRect,
        "c-block": xe.stackRect,
        "if-block": xe.stackRect,
        celse: xe.stackRect,
        cend: xe.stackRect,
        cap: xe.capRect,
        reporter: xe.roundedRect,
    ...
    Xt.prototype.drawSelf = function(e, t, s) {
        ...
        if (this.isRing) {
            ...
            if (o && (o.isInput || o.isBlock || o.isScript)) {
                ...
                return xe.ringRect(e, t, o.y, o.width, o.height, i, {
                    class: ["sb-" + this.info.category, "sb-bevel"].join(" ")
                })
            }
        }
    ...
    Xt.prototype.minDistance = function(e) {
        return this.isBoolean ? e.isReporter ? 0 | 4 + e.height / 4 : e.isLabel ? 0 | 5 + e.height / 2 : e.isBoolean || "boolean" === e.shape ? 5 : 0 | 2 + e.height / 2 : this.isReporter ? e.isInput && e.isRound || (e.isReporter || e.isBoolean) && !e.hasScript ? 0 : e.isLabel ? 0 | 2 + e.height / 2 : 0 | -2 + e.height / 2 : 0
    }
    ,
    Xt.padding = {
        hat: [15, 6, 2],
    ...
    Xt.prototype.draw = function() {
        function e(e) {
            0 === w.length ? g.height += a + r : (g.height += e ? 0 : 2,
            g.y -= 1),
            c += g.height,
            w.push(g)
        }
        var t = "define-hat" === this.info.shape
          ...
          , g = new l(c);
        if (this.info.isRTL) {
            for (var f = 0, m = function() {
                s = s.slice(0, f).concat(s.slice(f, b).reverse()).concat(s.slice(b))
            }
            .bind(this), b = 0; b < s.length; b++)
                s[b].isScript && (m(),
                f = b + 1);
            f < b && m()
        }
        for (var k, w = [], b = 0; b < s.length; b++)
            if (k = s[b],
            k.el = k.draw(this),
            k.isScript && this.isCommand)
                this.hasScript = !0,
                e(),
                k.y = c,
                w.push(k),
                u = E(u, E(1, k.width)),
                k.height = E(12, k.height) + 3,
                c += k.height,
                g = new l(c);
            else if (k.isArrow)
                g.children.push(k);
                ...
                k.x = g.width,
                g.width += k.width,
                d = E(d, g.width + E(0, S - n)),
                g.width += 4,
                k.isLabel || (g.height = E(g.height, k.height)),
                g.children.push(k)
            }
        if (e(!0),
        d = E(d + 2 * n, this.isHat || this.hasScript ? 83 : this.isCommand || this.isOutline || this.isRing ? 39 : 20),
        this.height = c,
        this.width = u ? E(d, 15 + u) : d,
        t) {
            var O = v(26, 0 | 3.5 + .13 * d) - 18;
            this.height += O,
            a += 2 * O
        }
        this.firstLine = w[0],
        ...
        for (var g, p = [], b = 0; b < w.length; b++) {
            if (g = w[b],
            g.isScript) {
                p.push(xe.move(15, g.y, g.el));
                continue
            }
            for (var k, R = g.height, h = 0; h < g.children.length; h++) {
                if (k = g.children[h],
                k.isArrow) {
                    p.push(xe.move(d - 15, this.height - 3, k.el));
                    continue
                }
                var c = a + (R - k.height - a - r) / 2 - 1;
                if ((t && k.isLabel ? c += 3 : k.isIcon && (c += 0 | k.dy),
                !(this.isRing && (k.y = 0 | g.y + c,
                k.isInset))) && (p.push(xe.move(n + k.x, 0 | g.y + c, k.el)),
                "+" === k.diff)) {
                    var I = xe.insEllipse(k.width, k.height);
                    p.push(xe.move(n + k.x, 0 | g.y + c, I))
                }
            }
        }
        var C = this.drawSelf(d, this.height, w);
        return p.splice(0, 0, C),
        this.info.color && xe.setProps(C, {
    ...
    qt.prototype.draw = function() {
        ...
        xe.group([xe.commentLine(this.hasBlock ? qt.lineLength : 0, 6), xe.commentRect(this.width, this.height, {
            class: "sb-comment"
        }), xe.move(8, 4, e)])
    }
    ;
    ...
    Zt.prototype.drawSelf = function() {
        var e, t = this.child, s = this.width, o = this.height - 1;
        if (t.isScript)
            e = !t.isEmpty && t.blocks[0].isHat ? xe.hatRect(s, o) : t.isFinal ? xe.capRect(s, o) : xe.stackRect(s, o);
        else
            var e = t.drawSelf(s, o, []);
        return xe.setProps(e, {
    ...
    Zt.prototype.draw = function() {
        ...
        xe.group([t, this.drawSelf()])
    }
    ;
    var Qt = function(e) {
        t(this, e),
        this.blocks = e.blocks.map(es),
        this.y = 0
    };
    Qt.prototype.isScript = !0,
    Qt.prototype.measure = function() {
        for (var e = 0; e < this.blocks.length; e++)
            this.blocks[e].measure()
    }
    ,
    Qt.prototype.draw = function(e) {
        ...
        for (var o = 0; o < this.blocks.length; o++) {
            var a = this.blocks[o]
              , n = e ? 0 : 2
              , r = a.draw();
            t.push(xe.move(n, s, r)),
            this.width = E(this.width, a.width);
            var c = a.diff;
            if ("-" === c) {
                var l = a.width
                  , p = a.firstLine.height || a.height;
                t.push(xe.move(n, s + p / 2 + 1, xe.strikethroughLine(l))),
                this.width = E(this.width, a.width)
            }
            s += a.height;
            var h = a.comment;
            if (h) {
                var d = a.firstLine
                  ...
                  , f = h.draw();
                t.push(xe.move(u, g - h.height / 2, f)),
                this.width = E(this.width, u + h.width)
            }
        }
    ...
    Jt.prototype.render = function() {
        ...
        for (var e, t = 0, s = 0, o = [], a = 0; a < this.scripts.length; a++)
            ...
            s && (s += 10),
            e.y = s,
            o.push(xe.move(0, s, e.draw())),
            s += e.height,
            t = E(t, e.width + 4);
        this.width = t,
        this.height = s;
        var n = xe.newSVG(t, s);
        return n.appendChild(this.defs = xe.withChildren(xe.el("defs"), [jt("bevelFilter", !1), jt("inputBevelFilter", !0), Ut("inputDarkFilter")].concat(Vt()))),
        n.appendChild(xe.group(o)),
        this.el = n,
        n
    }
    ,
    Jt.prototype.exportSVGString = function() {
        ...
        var t = new xe.XMLSerializer().serializeToString(this.el);
    ...
    Jt.prototype.toCanvas = function(e, t) {
        t = t || 1;
        var s = xe.makeCanvas();
        s.width = this.width * t,
        s.height = this.height * t;
    ...
    var $t = function(e) {
      ...
      , os = e(function(e) {
        ...
        var o, i, a = {
            ...
            setProps: function(e, t) {
                for (var s in t) {
                    var o = "" + t[s];
                    a[s] ? e[s] = o : /^xlink:/.test(s) ? e.setAttributeNS("http://www.w3.org/1999/xlink", s.slice(6), o) : null !== t[s] && t.hasOwnProperty(s) && e.setAttributeNS(null, s, o)
                }
                return e
            },
            withChildren: function(e, t) {
            ...
            polygon: function(e) {
                return n.el("polygon", s(e, {
                    points: e.points.join(" ")
                }))
            },
            path: function(e) {
                return n.el("path", s(e, {
                    path: null,
                    d: e.path.join(" ")
                }))
            },
            ...
            pointedPath: function(e, t) {
                var s = t / 2;
                return [["M", s, 0].join(" "), ["L", e - s, 0, e, s].join(" "), ["L", e, s, e - s, t].join(" "), ["L", s, t, 0, s].join(" "), ["L", 0, s, s, 0].join(" "), "Z"]
            },
            pointedRect: function(e, t, o) {
                return n.path(s(o, {
                    path: n.pointedPath(e, t)
                }))
            },
            topNotch: function(e, t) {
                return ["c 2 0 3 1 4 2", "l 4 4", "c 1 1 2 2 4 2", "h 12", "c 2 0 3 -1 4 -2", "l 4 -4", "c 1 -1 2 -2 4 -2", ["L", e - 4, t].join(" "), "a 4 4 0 0 1 4 4"].join(" ")
            },
            getTop: function(e) {
            ...
            getRightAndBottom: function(e, t, s, o) {
                ...
                return s && (i = i.concat([["L", o + 48, t].join(" "), "c -2 0 -3 1 -4 2", "l -4 4", "c -1 1 -2 2 -4 2", "h -12", "c -2 0 -3 -1 -4 -2", "l -4 -4", "c -1 -1 -2 -2 -4 -2"])),
                0 === o ? (i.push("L", o + 4, t),
            ...
            getArm: function(e, t) {
                return [["L", 16, t - 4].join(" "), "a 4 4 0 0 0 4 4", ["L", 28, t].join(" "), n.topNotch(e, t)].join(" ")
            },
            getArmNoNotch: function(e, t) {
                return [["L", 16, t - 4].join(" "), "a 4 4 0 0 0 4 4", ["L", 28, t].join(" "), ["L", e - 4, t].join(" "), "a 4 4 0 0 1 4 4"].join(" ")
            },
            stackRect: function(e, t, o) {
                return n.path(s(o, {
            ...
            getCatTop: function(e) {
                return ["M 0 32", "c2.6,-2.3 5.5,-4.3 8.5,-6.2c-1,-12.5 5.3,-23.3 8.4,-24.8c3.7,-1.8 16.5,13.1 18.4,15.4c8.4,-1.3 17,-1.3 25.4,0c1.9,-2.3 14.7,-17.2 18.4,-15.4c3.1,1.5 9.4,12.3 8.4,24.8c3,1.8 5.9,3.9 8.5,6.1", ["L", e - 4, 32].join(" "), "a 4 4 0 0 1 4 4"].join(" ")
            },
            hatRect: function(e, t, o) {
                return n.path(s(o, {
            ...
            catHat: function(e, t, o) {
                return n.group([n.path(s(o, {
                    path: [n.getCatTop(e), n.getRightAndBottom(e, t, !0, 0), "Z"]
                })), n.move(0, 32, n.setProps(n.group([n.el("circle", {
                    cx: 29.1,
                    cy: -3.3,
                    r: 3.4
                }), n.el("circle", {
            ...
            procHatRect: function(e, t, o) {
                return n.path(s(o, {
                    path: [n.getProcHatTop(e), n.getRightAndBottom(e, t, !0, 0), "Z"]
                }))
            },
            mouthRect: function(e, t, o, a, r) {
                for (var c = a[0].height, l = [n.getTop(e), n.getRightAndBottom(e, c, !0, 16)], p = 1; p < a.length; p += 2) {
                    var h = p + 2 === a.length
                      , d = a[p];
                    c += d.height - 3,
                    d.isFinal ? l.push(n.getArmNoNotch(e, c)) : l.push(n.getArm(e, c));
                    var u = h ? 0 : 16;
                    c += a[p + 1].height + 3,
            ...
            commentRect: function(e, t, o) {
                return n.roundRect(e, t, s(o, {
                    class: "sb3-comment"
                }))
            },
            commentLine: function(e, t) {
                return n.move(-e, 9, n.rect(e, 2, s(t, {
      ...
      , _s = e(function(e) {
        var t = e.exports = {
            ...
            makeIcons: function() {
                return [os.setProps(os.group([os.el("path", {
                    ...
                    id: "sb3-greenFlag"
                }), os.setProps(os.group([os.el("path", {
                ...
                }), os.setProps(os.group([os.el("circle", {
                    opacity: .25,
                    cx: 32,
                    cy: 16,
                    r: 4.5
                    ...
                    id: "sb3-wedoBlock",
                    fill: "none"
                }), os.setProps(os.group([os.el("rect", {
                    stroke: "#7C87A5",
                    fill: "#FFF",
                    x: ".5",
                    y: "3.59",
            ...
            makeStyle: function() {
                var e = os.el("style");
                return e.appendChild(os.cdata(t.cssContent)),
                e
            },
    ...
    no.prototype.isLabel = !0,
    no.prototype.draw = function() {
        return this.el
    }
    ,
    Object.defineProperty(no.prototype, "width", {
        get: function() {
            return this.metrics.width
        }
    }),
    ...
    no.prototype.measure = function() {
        var e = this.value
          , t = "sb3-" + this.cls;
        this.el = os.text(0, 13, e, {
            class: "sb3-label " + t
        });
        var s = no.metricsCache[t];
        if (s || (s = no.metricsCache[t] = Object.create(null)),
        Object.hasOwnProperty.call(s, e))
            this.metrics = s[e];
        else {
            var o = /comment-label/.test(this.cls) ? oo : so;
            this.metrics = s[e] = no.measure(e, o)
        }
    }
    ,
    no.measure = function(e, t) {
        var s = no.measuring;
        s.font = t;
        var o = s.measureText(e)
          , i = 0 | o.width + .5;
    ...
    ro.prototype.isIcon = !0,
    ro.prototype.draw = function() {
    ...
    co.prototype.isLine = !0,
    co.prototype.measure = function() {}
    ,
    co.prototype.draw = function(e) {
    ...
    lo.prototype.draw = function(e) {
        if (this.isBoolean)
            ...
            var t = this.isInset ? 30 : null;
        this.hasArrow && (t += 20),
        this.width = t;
        var i = this.height = 32
          , a = lo.shapes[this.shape](t, i);
        os.setProps(a, {
            class: [this.isColor ? "" : "sb3-" + e.info.category, "sb3-input", "sb3-input-" + this.shape].join(" ")
        }),
        this.isColor ? os.setProps(a, {
            fill: this.value
        }) : "dropdown" === this.shape ? e.info.color && os.setProps(a, {
            fill: e.info.color,
            stroke: "rgba(0, 0, 0, 0.2)"
        }) : "number-dropdown" === this.shape ? (a.classList.add("sb3-" + e.info.category + "-alt"),
        e.info.color && os.setProps(a, {
            fill: "rgba(0, 0, 0, 0.1)",
            stroke: "rgba(0, 0, 0, 0.15)"
        })) : "boolean" === this.shape && (a.classList.remove("sb3-" + e.info.category),
        a.classList.add("sb3-" + e.info.category + "-dark"),
        e.info.color && os.setProps(a, {
            fill: "rgba(0, 0, 0, 0.15)"
        }));
        var n = os.group([a]);
        return this.hasLabel && n.appendChild(s),
        this.hasArrow && n.appendChild(os.move(t - 24, 13, os.symbol("#sb3-dropdownArrow", {}))),
        n
    }
    ;
    var po = function(e) {
        switch (t(this, e),
        this.children = e.children.map(yo),
        this.comment = this.comment ? yo(this.comment) : null,
        this.isRound = this.isReporter,
        this.info = t({}, e.info),
        this.info.category) {
        case "music":
            this.children.unshift(new co),
            this.children.unshift(new ro({
                name: "musicBlock"
            })),
            this.info.category = "extension";
            break;
    ...
    po.prototype.drawSelf = function(e, t, s) {
        if (1 < s.length)
        ...
        var i = po.shapes[this.info.shape];
        if (!i)
            throw new Error("no shape func: " + this.info.shape);
        return i(e, t, {
            class: ["sb3-" + this.info.category].join(" ")
    ...
    po.prototype.horizontalPadding = function(e) {
        if (this.isRound) {
            if (e.isIcon)
                return 16;
            if (e.isLabel)
    ...
    ,
    po.prototype.marginBetween = function(e, t) {
        return e.isLabel && t.isLabel ? 5 : 8
    }
    ,
    po.prototype.draw = function() {
        function e() {
            0 === A.length ? u.height += n + r : (u.height -= 11,
            u.y -= 2),
            c += u.height,
            A.push(u)
        }
        var t = "define-hat" === this.info.shape
          , s = this.children
          , o = this.isCommand
          , a = po.padding[this.info.shape] || po.padding[null]
          , n = a[0]
          , r = a[1]
        ...
        if (this.info.isRTL) {
            for (var g = 0, f = function() {
                s = s.slice(0, g).concat(s.slice(g, m).reverse()).concat(s.slice(m))
            }
            .bind(this), m = 0; m < s.length; m++)
                s[m].isScript && (f(),
                g = m + 1);
            g < m && f()
        }
        for (var b, k, w, A = [], m = 0; m < s.length; m++)
            if (w = s[m],
            w.el = w.draw(this),
            w.isScript && this.isCommand)
                this.hasScript = !0,
                e(),
                w.y = c - 1,
                A.push(w),
                d = E(d, E(1, w.width)),
                w.height = E(29, w.height + 3) - 2,
                c += w.height,
                u = new l(c),
                b = null;
            else if (w.isArrow)
                ...
                A.length || (k = w),
                b && (u.width += this.marginBetween(b, w));
                var S = 48 - this.horizontalPadding(s[0]);
                (this.isCommand || this.isOutline) && !w.isLabel && !w.isIcon && u.width < S && (u.width = S),
                w.isIcon && 0 === m && this.isCommand && (u.height = E(u.height, w.height + 8)),
                w.x = u.width,
                u.width += w.width,
                p = E(p, u.width),
                w.isLabel || (u.height = E(u.height, w.height)),
                u.children.push(w),
                b = w
            }
        e();
        ...
        p += L + O;
        var v = p;
        p = E(this.hasScript ? 160 : this.isHat ? 108 : this.isCommand || this.isOutline ? 64 : this.isReporter ? 48 : 0, p),
        this.isReporter && (L += (p - v) / 2),
        this.height = c,
        this.width = d ? E(p, 15 + d) : p,
        this.firstLine = A[0],
        this.innerWidth = p;
        for (var u, R = [], m = 0; m < A.length; m++) {
            ...
            for (var w, I = u.height, h = 0; h < u.children.length; h++) {
                ...
                w.isLabel && 0 === m ? c -= 1 : t && w.isLabel ? c += 3 : w.isIcon && (c += 0 | w.dy,
                this.isCommand && 0 === m && 0 === h && (c += 4));
                var C = L + w.x;
                w.dx && (C += w.dx),
                R.push(os.move(C, 0 | u.y + c, w.el))
            }
        }
        var T = this.drawSelf(p, this.height, A);
        return R.splice(0, 0, T),
        this.info.color && os.setProps(T, {
            fill: this.info.color,
            stroke: "rgba(0, 0, 0, 0.2)"
        }),
        os.group(R)
    ...
    var ho = function(e) {
        t(this, e),
        this.label = yo(e.label),
        this.width = null
    };
    ho.prototype.isComment = !0,
    ho.lineLength = 12,
    ho.prototype.height = 20,
    ho.prototype.measure = function() {
        this.label.measure()
    }
    ,
    ho.prototype.draw = function() {
        var e = this.label.draw();
        return this.width = this.label.width + 16,
        os.group([os.commentLine(this.hasBlock ? ho.lineLength : 0, 6), os.commentRect(this.width, this.height, {
            class: "sb3-comment"
        }), os.move(8, 4, e)])
    }
    ;
    var uo = function(e) {
        t(this, e),
        this.child = yo(e.child),
        this.width = null,
        this.height = null,
        this.y = 0
    };
    uo.prototype.isGlow = !0,
    uo.prototype.measure = function() {
        this.child.measure()
    }
    ,
    uo.prototype.drawSelf = function() {
        var e, t = this.child, s = this.width, o = this.height - 1;
        if (t.isScript)
            e = !t.isEmpty && t.blocks[0].isHat ? os.hatRect(s, o) : t.isFinal ? os.capRect(s, o) : os.stackRect(s, o);
        else
            var e = t.drawSelf(s, o, []);
        return os.setProps(e, {
            class: "sb3-diff sb3-diff-ins"
        })
    }
    ,
    uo.prototype.draw = function() {
        var e = this.child
          , t = e.isScript ? e.draw(!0) : e.draw();
        return this.width = e.width,
        this.height = e.isBlock && e.firstLine.height || e.height,
    ...
    var go = function(e) {
        t(this, e),
        this.blocks = e.blocks.map(yo),
        this.y = 0
    };
    go.prototype.isScript = !0,
    go.prototype.measure = function() {
        for (var e = 0; e < this.blocks.length; e++)
            this.blocks[e].measure()
    }
    ,
    go.prototype.draw = function(e) {
        var t = []
          , s = 1;
        this.width = 0;
        for (var o = 0; o < this.blocks.length; o++) {
            ...
            if (h) {
                var d = a.firstLine
                  , u = a.innerWidth + 2 + ho.lineLength
                  , g = s - a.height + d.height / 2
                  , f = h.draw();
    ...
    var fo = function(e) {
        t(this, e),
        this.scripts = e.scripts.map(yo),
        this.width = null,
        this.height = null,
        this.el = null,
        this.defs = null
    };
    fo.prototype.measure = function() {
        this.scripts.forEach(function(e) {
            e.measure()
        })
    }
    ,
    fo.prototype.render = function() {
        if ("function" == typeof ocbptions)
            throw new Error("render() no longer takes a callback");
        this.measure();
        for (var e, t = 0, s = 0, o = [], a = 0; a < this.scripts.length; a++)
        ...
        this.height = s;
        var n = os.newSVG(t, s);
        return n.appendChild(this.defs = os.withChildren(os.el("defs"), ao())),
        n.appendChild(os.group(o)),
        this.el = n,
        n
    }
    ,
    fo.prototype.exportSVGString = function() {
        if (null == this.el)
            throw new Error("call draw() first");
        var e = io();
        this.defs.appendChild(e);
    ...
    ,
    fo.prototype.exportSVG = function() {
        var e = this.exportSVGString();
        return "data:image/svg+xml;utf8," + e.replace(/[#]/g, encodeURIComponent)
    }
    ,
    fo.prototype.toCanvas = function(e, t) {
        t = t || 1;
        var s = os.makeCanvas();
        s.width = this.width * t,
        s.height = this.height * t;
    ...
    ,
    fo.prototype.exportPNG = function(e, t) {
        this.toCanvas(function(t) {
            if (URL && URL.createObjectURL && Blob && t.toBlob)
                t.toBlob(function(t) {
                    e(URL.createObjectURL(t))
    ...
    var mo = function(e) {
      ...
      , ko = {
        init: function(e) {
            os.init(e),
            bo.LabelView.measuring = function() {
                var e = os.makeCanvas();
                return e.getContext("2d")
            }()
        },
        newView: bo.newView,
        makeStyle: _s.makeStyle
    }
      , wo = function(e) {
        function s(e, t) {
            return c.parse(e, t)
        ...
        function n(e, t, s, o) {
            if (o.inline) {
                ...
                s.scripts[0] && !s.scripts[0].isEmpty && (a += " scratchblocks-inline-" + s.scripts[0].blocks[0].shape),
                i.className = a,
        ...
        return {
            ...
            appendStyles: function() {
                r.head.appendChild(b.makeStyle()),
                r.head.appendChild(k.makeStyle())
            }
        }
    }
      , Ao = e(function(e) {
        var t = window.scratchblocks = e.exports = wo(window);
        t.appendStyles()
    });
    return Ao
}();
